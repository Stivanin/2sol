...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Informe abaixo as informações do funcionário
                    <a class="float-right" href="{{url('clientes') }}">Listagem Funcionarios</a>
                </div>
                ...
                {!! Form::input('text', 'telefone', null, ['class' => 'form-control', '', 'placeholder' => '(35)9 1234-5678']) !!}<br />

                <strong>{!!Form::label('admissao','Data de Admissão do Funcionário') !!}</strong>
